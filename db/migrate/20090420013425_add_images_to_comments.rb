...
class AddImagesToComments < ActiveRecord::Migration
  def self.up
    add_column :comments, :img1, :string
    add_column :comments, :img2, :string
    add_column :comments, :img3, :string
  end

  def self.down
    remove_column :comments, :img1
    remove_column :comments, :img2
    remove_column :comments, :img3
  end
end
